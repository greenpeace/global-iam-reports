...
public class GPUserReport01 implements ReportDataSetBuilder {
    ...
    public ReportDataDto getReportData(ReportQueryDto query) {
        ...
        println "GPUserReport01 data source, request: " + query.queryParams.values().join(", ")
        ...
        if (isHeadRequest) {
            ...
            reportTable.setName("GPUserReport01")
        ...
        println "GPUserReport01 data source, responce size: " + reportTable.row.size() + " rows"
